<xsl:stylesheet xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.0" exclude-result-prefixes="xsl ddwrt msxsl" xmlns:ddwrt="http://schemas.microsoft.com/WebParts/v2/DataView/runtime" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
			...
			<xsl:otherwise>
				<table border="0" width="100%" cellpadding="2" cellspacing="0">
					<tr valign="top">
						...
						<th class="ms-vh" nowrap="nowrap">Charity_x0020_Name</th>
						<th class="ms-vh" nowrap="nowrap">Address</th>
						<th class="ms-vh" nowrap="nowrap">Year_x0020_founded</th>
						<th class="ms-vh" nowrap="nowrap">Category</th>
					</tr>
			...
			<xsl:if test="true()">
				<xsl:if test="not($HideGroupDetail)" ddwrt:cf_ignore="1">
					<tr style="display:{$GroupStyle}">
						...
						<td class="ms-vb">
							<xsl:value-of select="Year_x0020_founded"/>
						</td>
						<td class="ms-vb">
